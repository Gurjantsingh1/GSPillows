...
namespace GSPillows.Controllers
{
    ...
    {
        private readonly GSPillowsContext _context;

        public PillowsController(GSPillowsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Size,Color,Material,Rating")] Pillow pillow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Size,Color,Material,Rating")] Pillow pillow)
        {
            if (id != pillow.Id)
            {
                return NotFound();
